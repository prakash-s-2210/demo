...
var getTrackLeft = function getTrackLeft(spec) {
  ...
  if (variableWidth === true) {
    ...
    } else if (infinite !== true && snapToRight === true && slideIndex + 1 >= slideCount) {
      targetLeft = targetLeft + slideWidth - targetSlide.offsetWidth;
    }
  }
...
var defaultProps = {
  ...
  vertical: false,
  waitForAnimate: true,
  snapToRight: false // added by th.park@ : when infinite option is false, last element snaps to right.
